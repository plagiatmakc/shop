<template>
    <div class="container" v-if="loading==false">
        ...
        <ul style="list-style-type:none;" >
            <li style="display: inline-block;" >&nbsp;<router-link :to="{path: '/'}">Main</router-link></li>
            <li v-if="breadcrumbsCategory.length" v-for="breadCrumb in breadcrumbsCategory" style="display: inline-block;">&raquo;&nbsp;<router-link :to="{path: '/category/'+ breadCrumb.id }">{{breadCrumb.title}}</router-link>&nbsp;</li>
        </ul>
        <div id="product_row" class="row" style="border: solid 1px;">
            <div id="product_images" class="col-md-6" style="border-right: 1px solid; max-width: 50%">
                <div class="row" v-if="loading==false">
                    <div class="col-md-4 " >
                        <img v-if="productImages.length" class="main_img" :src="'storage/'+productImages[0].link_to_file" />
            ...
            <div id="fold_content" style="margin-left: auto; margin-right: auto; padding: 2%; max-width: 50% ">
                ...
                <div class="row form-inline" style="margin-left: auto; margin-right: auto; padding: 2%; max-width: 500px; ">
